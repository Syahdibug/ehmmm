...
class _ReportWaPageState extends State<ReportWaPage> {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['valid'] == true) {
          ...
          if (connections['private'] != null)
            loaded.addAll(connections['private']);
          if (connections['global'] != null)
            loaded.addAll(connections['global']);
  ...
  Future<void> _executeProtocol() async {
    ...
    setState(() {
      _isAttacking = false;
      _logs.add(
        "[SYSTEM] Mission Ended. Success: $_successCount, Fail: $_failCount",
      );
    });
  }
      ...
      appBar: AppBar(
        ...
        leading: Container(
          ...
          decoration: BoxDecoration(
            color: _cardTheme.withOpacity(0.5),
  ...
  Widget _buildUserCard() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(color: _primaryPink.withOpacity(0.1), blurRadius: 10),
        ],
      ),
      child: Row(
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _availableSenders.isNotEmpty ? Colors.green : Colors.red,
              ),
            ),
            child: Row(
              children: [
                Icon(
                  Icons.circle,
                  color: _availableSenders.isNotEmpty
                      ? Colors.green
                      : Colors.red,
                  size: 8,
                ),
    ...
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: (_isAttacking ? Colors.red : _primaryPink).withOpacity(
                0.4,
              ),
              blurRadius: 15,
